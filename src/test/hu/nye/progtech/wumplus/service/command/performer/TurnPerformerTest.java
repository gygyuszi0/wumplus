...
class TurnPerformerTest {
    ...
    private final PlayerVO PLAYER_NORTH = new PlayerVO("north", PlayerConst.NORTH, new CoordinateVO(1,1), new CoordinateVO(1, 1));
    private final PlayerVO PLAYER_WEST = new PlayerVO("west", PlayerConst.WEST, new CoordinateVO(1,1), new CoordinateVO(1, 1));
    ...
    private static TurnPerformer turnPerformer;

    @BeforeEach
    void setUp() {
        turnPerformer = new TurnPerformer();
    }
    ...
    void northToRight() {
        ...
        PlayerVO expected = new PlayerVO("north", PlayerConst.EAST, new CoordinateVO(1,1), new CoordinateVO(1, 1));
    ...
    void northtoLeft() {
        ...
        PlayerVO expected = new PlayerVO("north", PlayerConst.WEST, new CoordinateVO(1,1), new CoordinateVO(1, 1));
        System.out.println("\t\t\tWHEN\t:" + result);
        System.out.println("\t\t\t\t\t:" + expected);
        // then
        Assertions.assertEquals(result, expected);
    ...
    void westToRight() {
        ...
        PlayerVO expected = new PlayerVO("west", PlayerConst.NORTH, new CoordinateVO(1,1), new CoordinateVO(1, 1));
        System.out.println("\t\t\tWHEN\t:" + result);
        System.out.println("\t\t\t\t\t:" + expected);
        // then
        Assertions.assertEquals(result, expected);
    ...
    void westToLeft() {
        ...
        PlayerVO expected = new PlayerVO("west", PlayerConst.SOUTH, new CoordinateVO(1,1), new CoordinateVO(1, 1));
        System.out.println("\t\t\tWHEN\t:" + result);
        System.out.println("\t\t\t\t\t:" + expected);
        // then
        Assertions.assertEquals(result, expected);
